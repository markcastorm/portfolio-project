    ...
    <div className="container mx-auto h-full flex flex-col items-center 
      ...
      <div className="flex-1 flex flex-col justify-center">
        ...
        <motion.p 
          ...
          Ive done remotework for agencies, consulted for startups,
          ...
          {aboutData.map((item, itemIndex)=> {
            return (
              <div 
                ...
                className={`${
                  index === itemIndex && 
                  'text-accent after:w-[100%] after:bg-accent after:transition-all after:duration-300' } cursor-pointer capitalize xl:text-lg relative after after:h-[2px] after:bg-white after:absolute after:-bottom-1
                after:left-0`}
